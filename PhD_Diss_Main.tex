...
\cleardoublepage
% References
%For generation of bibliography file use this command.
% For this the user is require to run Xelatex + LatexMk and Xelatex command again
% Moreover in the setup/package.tex; the \usepackage[numbers]{natbib} and \usepackage{cite} must be uncommented
%\twelve
...
%this is for manual bibliography entry via \bibitem
% For this LatexMk does not need to be run
% \usepackage[numbers]{natbib} and \usepackage{cite} should be commented in setup/package.tex
% \usepackage[numbers,sort&compress,square,super]{natbib}  should be uncommented in the same texfile.
\defaultfont
\wuhao
